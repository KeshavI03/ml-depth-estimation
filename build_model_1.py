...
from tensorflow.keras.layers import Conv2D, BatchNormalization, Activation, MaxPooling2D, UpSampling2D, concatenate, Input, Dropout, Conv2DTranspose
...
#     convm = Conv2D(start_neurons * 16, (3, 3), activation="relu", padding="same")(convm)
    ...
    deconv5 = Conv2DTranspose(512, (3,3), strides=(2, 2), padding = 'same')(pool5)
...
#     deconv1 = UpSampling2D(size=(2, 2), interpolation='bilinear')(uconv2)
